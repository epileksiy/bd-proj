...
(function (global, factory) {
  ...
  var Dark = {
    ...
    __updateMedia: function __updateMedia () {
  ...
  */
  ...
  var QScrollArea = Vue.extend({
    ...
    computed: {
      ...
      desktopEvents: function desktopEvents () {
        var this$1 = this;
  ...
  var RowSelection = {
    ...
    computed: {
      ...
      allRowsSelected: function allRowsSelected () {
        ...
        if (this.multipleSelection === true) {
          return this.computedRows.length > 0 && this.computedRows.every(function (row) { return this$1.selectedKeys[ this$1.getRowKey(row) ] === true; })
        }
      },
      ...
      someRowsSelected: function someRowsSelected () {
        ...
        if (this.multipleSelection === true) {
          return !this.allRowsSelected && this.computedRows.some(function (row) { return this$1.selectedKeys[ this$1.getRowKey(row) ] === true; })
        }
      },
